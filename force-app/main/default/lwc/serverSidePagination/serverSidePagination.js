...
import getAccountsBasedOnPageNumber from '@salesforce/apex/AccountBasicDatatableController.getAccountsBasedOnPageNumber';
...
export default class ServerSidePagination extends LightningElement {
    ...
    @wire(getAccountsBasedOnPageNumber, { pageSize: '$pageSize', pageNumber: '$pageNumber' })
    accountData (result) {
        if(result.data) {
